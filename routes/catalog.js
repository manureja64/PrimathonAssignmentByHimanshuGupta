...
var storage = multer.diskStorage({
    destination: (req, file, cb) => {
        cb(null, './controllers/public/uploads');
    },
    filename: (req, file, cb) => {
...
router.post('/test/create', authMiddleware, uploads.single("uploadfile"), test_controller.test_create_post);
...
router.post('/tests', test_controller.test_list_post);
...
router.post('/direction/create/:id', uploads.single("uploadfile"), direction_controller.direction_create_post); //:id is the _id of test
...
router.post('/question/create/:id', uploads.single("uploadfile"), question_controller.question_create_post);      //:id is the _id of direction
